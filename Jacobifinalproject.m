...
set(gca,'FontSize',20)
axis tight
title('Temperature Field using Jacobi for 50x50', 'Fontsize', 17)
...
set(gca,'FontSize',20)
axis tight
title(['Temperature Field using Jacobi for ' num2str(n100) 'x' num2str(n100)])
...
set(gca,'FontSize',20)
axis tight
title(['Temperature Field using Jacobi for ' num2str(n200) 'x' num2str(n200)])
...
xlabel('x')
ylabel('Temperature')
legend({'50x50','100x100', '200x200'},'Location','northeast', 'Fontsize',14)
axis tight
set(gca,'FontSize',20)
grid on
title('Centre-line Temperature using Jacobi for all cases' , 'Fontsize',14)
...
grid on
hold off
title('Log of Residual vs. Iterations using Jacobi for all cases', 'Fontsize',15)
...
grid on
hold off
title('Log of Residual vs. CPU Time using Jacobi for all cases', 'Fontsize',15)
